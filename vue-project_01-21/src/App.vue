...
//import Exemplo01 from './componentes/Exemplo01Interpolacao.vue'; <- COMPONENTE NÃO MAIS UTILIZAVEIS
...
<!--DÚVIDAS-->
<!--É uma boa prática comentar meus imports antigos, para que a medida que o código não haja possíveis conflitos?-->